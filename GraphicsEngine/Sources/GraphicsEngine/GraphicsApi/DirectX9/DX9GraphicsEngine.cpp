...
//#include "Internal/InternalGUI.h"
#include "GraphicsApi/DirectX9/DX9GraphicsEngineContext.h"
#include "Time.h"


DX9GraphicsEngine * pDX9Engine = nullptr;
...
void DX9GraphicsEngine::SetRenderTarget(float r, float g, float b)
{
	...
	// Clear the z-buffer
	m_pDevice->Clear( 0L, nullptr, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DCOLOR_XRGB( int(r*255), int(g*255), int(b*255) ), 1.0f, 0L );
...
void DX9GraphicsEngine::SetRenderTarget(const RenderTexture * pRenderTexture)
{
	...
	m_pDevice->Clear( 0L, nullptr, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, 0xffffffff, 1.0f, 0L );
...
void DX9GraphicsEngine::ResetRenderTarget(const RenderTexture * pRenderTexture)
{
	...
	{
		if ( SUCCEEDED( m_pDevice->Present( nullptr, nullptr, nullptr, nullptr ) ) )
		{
			int i = 0;
		}
	}
