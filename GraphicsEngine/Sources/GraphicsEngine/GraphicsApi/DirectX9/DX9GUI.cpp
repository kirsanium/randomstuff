...
LPDIRECT3DDEVICE9	DX9GUI::m_pDevice	= nullptr;
ID3DXFont *			DX9GUI::m_pFont		= nullptr;
...
void DX9GUI::Label(int x, int y, int w, int h, const char * pText)
{
	...
	m_pFont->DrawTextA(nullptr, pText, (int)strlen(pText), &rect, DT_LEFT | DT_NOCLIP, 0xffffffff);
}
